...
public class SftpTool {
	public static void main(String[] args) {
        String hostName = "192.168.110.241:22";
        String username = "root";
        String password = "Zaq1_2wsx";

        String localFilePath = "D:\\SCI\\Test\\test3.txt";
        String remoteFilePath = "/tmp/test2.txt";       
        String remoteTempFilePath = "/tmp/test2.txt";
